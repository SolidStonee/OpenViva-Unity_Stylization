...
namespace viva
{
    public class Bracelet : ClothingScript
    {
        ...
        public override void OnBeginWearing(Companion companion)
        {

            wrist = companion.bodyArmature.Find("spine1/spine2/spine3/shoulder_l/armControl_l/forearmControl_l/wrist_l");
