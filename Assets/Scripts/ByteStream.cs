...
namespace Viva
{
    ...
    public class ByteStreamReader
    {
        ...
        public float Read1ByteNormalFloat()
        {// -1~1
            return ((float)data[index++] / 255.0f) * 2.0f - 1.0f;
        }

        public float ReadUnsigned1ByteNormalFloat()
        {// 0~1
    ...
    public class ByteStreamWriter
    {
        ...
        public void WriteNormal1ByteFloat(float f)
        {    //f must be -1~1
            WriteByte((byte)(Mathf.RoundToInt(f * 128.0f) + 127));
        }

        public void WriteUnsignedNormal1ByteFloat(float f)
        {    //f must be -1~1
