...
namespace Viva
{
    ...
    public partial class Companion : Character
    {
        ...
        public void BeginRagdollMode(float muscleWeight, Companion.Animation animation)
        {
        ...
        private IEnumerator RegainBalance()
        {
            ...
            SoundManager.main.RequestHandle(floorPos).PlayOneShot(GameDirector.instance.companionSettings.getUpSound.GetRandomAudioClip());
            animationSpeed = 0.0f;
