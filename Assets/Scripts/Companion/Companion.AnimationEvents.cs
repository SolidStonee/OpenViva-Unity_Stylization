...
namespace viva
{
    ...
    public partial class Companion : Character
    {
        ...
        public abstract class TransitionHandle
        {
            ...
            public abstract void Transition(Companion companion);
        }
        ...
        public sealed class DefaultTransition : TransitionHandle
        {
            ...
            public DefaultTransition(Companion.Animation _nextAnim) : base(TransitionType.DEFAULT)
            {
                nextAnim = _nextAnim;
            }
            public override void Transition(Companion companion)
            {
                companion.UpdateAnimationTransition(nextAnim);
            }
        }
        ...
        public class TransitionToIdle : TransitionHandle
        {
            ...
            public override void Transition(Companion companion)
            {
                companion.UpdateAnimationTransition(companion.GetLastReturnableIdleAnimation());
            }
        }
        ...
        public class AnimationInfo
        {
            ...
            public void Validate(Companion companion)
            {
                if (legsStateName != null)
                {
                    if (!companion.animator.HasState(0, legsStateID))
                    {
                ...
                {
                    if (!companion.animator.HasState(1, torsoStateID))
                    {
                ...
                {
                    if (!companion.animator.HasState(2, faceStateID))
                    {
        ...
        private void FixedUpdateAnimationEvents()
        {
            ...
            rightCompanionHandState.UpdateAnimationHoldBlendMap();
            leftCompanionHandState.UpdateAnimationHoldBlendMap();
        ...
        public void HandleAnimationEvent(LoliAnimationEvent animEvent)
        {
            ...
            switch (animEvent.nameID)
            {
                case (int)AnimationEventName.BLEND_CONTROLLER_RIGHT:
                    rightCompanionHandState.SetupAnimationHoldBlendMap(parameters);
                    break;
                case (int)AnimationEventName.BLEND_CONTROLLER_LEFT:
                    leftCompanionHandState.SetupAnimationHoldBlendMap(parameters);
                    break;
                ...
                case (int)AnimationEventName.WEAR_HAT_RIGHT_HAND:
                    DebugAssert(animEvent, -1);
                    active.idle.AttachHandHat((CompanionHandState)rightHandState);
                    break;
                case (int)AnimationEventName.WEAR_HAT_LEFT_HAND:
                    DebugAssert(animEvent, -1);
                    active.idle.AttachHandHat((CompanionHandState)leftHandState);
                    break;
                ...
                case (int)AnimationEventName.THROW_RIGHT_HAND_OBJECT:
                    DebugAssert(animEvent, -1);
                    active.idle.ThrowHandObject((CompanionHandState)rightHandState);
                    break;
                case (int)AnimationEventName.THROW_LEFT_HAND_OBJECT:
                    DebugAssert(animEvent, -1);
                    active.idle.ThrowHandObject((CompanionHandState)leftHandState);
                    break;
                ...
                case (int)AnimationEventName.BIND_ANIMATION_TO_VIEW_MODE:
                    DebugAssert(animEvent, 1);
                    BindAwarenessModeToAnimation((Companion.AwarenessMode)parameters[0]);
                    break;
