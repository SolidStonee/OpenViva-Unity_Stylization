...
namespace Viva
{
    ...
    public partial class Companion : Character
    {
        ...
        public CompanionHandState GetPreferredHandState(Item item)
        {
            ...
            if (item == null)
            {
                if (rightHandState.occupied)
                {
                    ...
                    return leftCompanionHandState;
                }
                return rightCompanionHandState;
            }
            bool shouldUseRightHand = item.ShouldPickupWithRightHand(this);
            CompanionHandState destHandState = null;
            //check if HandState is allowed
            if (shouldUseRightHand)
            {
                if (rightCompanionHandState.heldItem == null)
                {
                    destHandState = rightCompanionHandState;
                }
                else if (leftCompanionHandState.heldItem == null)
                {
                    destHandState = leftCompanionHandState;
                }
            }
            else
            {
                if (leftCompanionHandState.heldItem == null)
                {
                    destHandState = leftCompanionHandState;
                }
                else if (rightCompanionHandState.heldItem == null)
                {
                    destHandState = rightCompanionHandState;
                }
            }
        ...
        public void OnAnimationChange(Animation oldAnim, Animation newAnim)
        {
            ...
            if (m_currentAnim == Companion.Animation.NONE)
            {
            ...
            rightCompanionHandState.SetupAnimationHoldBlendMap(null);
            leftCompanionHandState.SetupAnimationHoldBlendMap(null);
