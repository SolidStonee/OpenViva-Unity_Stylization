...
namespace Viva
{
    ...
    public partial class Companion : Character
    {
        ...
        protected override void OnCharacterAwake()
        {
            ...
            leftCompanionHandState.InitializeIK();
        ...
        private void DebugIK()
        {
            ...
            debugArmIK.OverrideWorldRetargetingTransform(
                ...
                rightCompanionHandState.fingerAnimator.hand.rotation
            );
        ...
        {
            if (rightCompanionHandState == null || leftCompanionHandState == null)
            {
                return;
            }
            ...
            Gizmos.DrawSphere(leftCompanionHandState.holdRetargeting.target, 0.05f);
